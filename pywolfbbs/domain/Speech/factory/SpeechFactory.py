...
class SpeechFactory:
    ...
    @staticmethod
    def create(no: int, dt: datetime, text: str, player_id: str, vil_no: int, vil_date: int
               ,member_title: str, member_name: str) -> Speech:
        ...
        speech.setValues(
            ...
            GameVilDateNum(vil_date), VilMemberTitle(member_title), VilMemberName(member_name)
        )
